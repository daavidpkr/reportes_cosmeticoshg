...
class _ReporteScreenState extends State<ReporteScreen> {
                ...
                child: Column(
                  ...
                  children: [
                    TextField(
                      ...
                      decoration: const InputDecoration(
                        labelText:
                            'Factura, cliente, nombre comercial o vendedor',
  ...
  Widget _encabezado(String titulo, String columna) => Row(
    ...
    children: [
      ...
      PopupMenuButton<String>(
        ...
        itemBuilder: (_) => [
          const PopupMenuItem(value: 'asc', child: Text('Orden ascendente')),
          const PopupMenuItem(value: 'desc', child: Text('Orden descendente')),
  ...
  Widget _vistaMovil() => Scaffold(
    ...
    floatingActionButton:
        _vistaCobrosMensuales || _vistaEstadisticas || _vistaVendedores
        ? null
    ...
    body: _vistaVendedores
        ...
        : _vistaCobrosMensuales
        ? SafeArea(
            child: CobrosMensualesView(key: ValueKey(_versionCobrosMensuales)),
          )
        : SafeArea(
                  ...
                  sliver: SliverList.list(
                    children: [
                      ...
                      Row(
                        children: [
                          Text(
                            _vistaGeneral ? 'Todos los registros' : 'Clientes',
                            style: TextStyle(
  ...
  Widget _encabezadoMovil() => Row(
    children: [
      ...
      SizedBox(
        ...
        child: DropdownButtonFormField<String>(
          isExpanded: true,
          initialValue: _reportes.reportes.isEmpty ? null : _reportes.activo.id,
          decoration: const InputDecoration(
          ...
          onChanged: (id) async {
            if (id == null) return;
            await _guardarProgreso();
            _activarReporte(_reportes.reportes.firstWhere((r) => r.id == id));
          },
        ),
      ),
    ],
  ...
  Widget _barraSuperior() => Container(
    ...
    decoration: const BoxDecoration(
      gradient: LinearGradient(colors: [Color(0xFF591530), Color(0xFF3D1A4A)]),
    ),
    child: Row(
      children: [
        Container(
  ...
  Widget _botonZoom() => PopupMenuButton<double>(
    ...
    child: const Tooltip(
      message: 'Zoom',
      child: Padding(padding: EdgeInsets.all(10), child: Icon(Icons.zoom_in)),
    ),
  );
  ...
  DataRow _crearFila(int indice, FilaVenta fila) => DataRow(
    ...
    color: fila.pagada
        ? WidgetStatePropertyAll(context.hg.positive.withValues(alpha: 0.12))
        : null,
    cells: [
      DataCell(
        Container(
